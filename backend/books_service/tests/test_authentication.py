"""
Unit tests for books.authentication module.
...
from books.authentication import JWTAuthentication, RemoteUser
...
class TestRemoteUser:
    ...
    def test_remote_user_initialization(self, user_data):
        ...
        assert user.permissions == ['can_view_books', 'can_borrow_book']
...
class TestJWTAuthentication:
    ...
    @patch('books.authentication.requests.post')
    ...
    @patch('books.authentication.requests.post')
    def test_authenticate_request_exception(self, mock_post, jwt_auth, mock_request):
        """Test raises AuthenticationFailed on other request exceptions."""
        mock_request.headers = {'Authorization': 'Bearer valid_token'}
